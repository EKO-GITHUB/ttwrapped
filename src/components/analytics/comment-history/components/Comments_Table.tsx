...
import { comments_table_columns } from "./Comments_Table_Columns";
import { Comment_Item } from "@/types/TikTok_Data_Schema";

export default function Comments_Table({ comments }: { comments: Comment_Item[] }) {
  const columns = useMemo(() => comments_table_columns, []);
