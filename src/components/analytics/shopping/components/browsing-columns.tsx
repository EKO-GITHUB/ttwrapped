...
import { Product_Browsing_History_Item_Schema } from "@/types/TikTok_Data_Schema";
import { z } from "zod";

type Product_Browsing_History_Item = z.infer<typeof Product_Browsing_History_Item_Schema>;

export const browsing_history_columns: ColumnDef<Product_Browsing_History_Item>[] = [
  {
    accessorKey: "browsing_date",
    header: "Date & Time",
    cell: ({ getValue }) => {
